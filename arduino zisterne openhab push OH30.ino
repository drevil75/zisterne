...
//-----------Openhab-Daten-------------------
String ohaddress = "192.168.0.50:38080";  //IP-Adresse:Port oder DNS-Name:Port
String itemname_lvl = "WasserstandZisterne";          //hier bei Bedarf den Namen des Items für den Füllstand in % eintragen.
long refreshRate = 60;                     //Interval in Sekunden, wie oft der Wasserstand an den Server übermittelt wird.
//-------------------------------------------

//-----------Zisternen-Daten-----------------
float distmin = 46;                       //minimaler Abstand vom Sensor zur Wasseroberfläche - Zisterne ist voll
